...
%\end{itemize}
\begin{longtable}{r|p{12cm}}
	\emph{2024} & PIERS 2024, ICC 2024, CoSeRa 2024, EECSI 2024. \\
	\multicolumn{2}{c}{} \\
...
\item \textcolor{blue}{M. Wang, X. Qiu$\ast$, \underline{Z. Zhang}, and S. Gao, ``Unsupervised Domain Adaptation for Cross-Modal 3D Point Cloud Semantic Segmentation from LiDAR to SAR,'' ISPRS Journal of Photogrammetry and Remote Sensing, \emph{under review}.}
	
\item \textcolor{blue}{\textbf{S. Gao, W. Wang, \underline{Z. Zhang$\ast$}, B. Zhang, and Y. Wu, ``Efficient gridless 2D DOA estimation based on generalized matrix-form atomic norm minimization,'' Electron. Lett., \emph{under review}}}.
	
\item \textcolor{blue}{\textbf{M. Shao, Y. Fan, Y. Zhang, \underline{Z. Zhang$\ast$}, J. Zhao, and B. Zhang ``A New Gridless Automotive MMV Radar Direction of Arrival Estimation Approach based on Improved Alternate Descent Conditional Gradient Algorithm,'' IEEE Trans. Antennas and Propagation, \emph{under review}}}.
...
\item \textcolor{blue}{\textbf{Z. Wang, Z. Wang, X. Qiu, and \underline{Z. Zhang$\ast$}, ``Fine Classification of Multi-Frequency PolSAR Images using an Adaptive Fusion Network,'' Electron. Lett., \emph{under review}}}.
...
\item \textcolor{blue}{\textbf{S. Gao, W. Wang, \underline{Z. Zhang$\ast$}, Z. Yang, X. Qiu, B. Zhang, and Y. Wu, ``A Robust Super-resolution Gridless Imaging Framework for UAV-borne SAR Tomography,'' IEEE Trans. Geosci. Remote Sens., \emph{under review}}}.
...
\item \textcolor{blue}{\textbf{Y. Wu, \underline{Z. Zhang$\ast$}, X. Qiu, Y. Zhao and W. Yu, ``MF-JMoDL-Net: A Deep Network for Azimuth Undersampling Pattern Design and Ambiguity Suppression for Sparse SAR Imaging'', IEEE Trans. Geosci. Remote Sens., \emph{under review}}}.
...
\item \textcolor{blue}{\textbf{S. Gao, \underline{Z. Zhang$\ast$}, M. Wang, Y. Zhang, J. Zhao, B. Zhang, Y. Wang and Y. Wu, ``Efficient Gridless DOA Estimation for Non-uniformly Spaced Linear Arrays in Automotive Radar Sensors,'' IEEE Sensors J., \emph{under review}}}.
