...
\item \textbf{R. Shi, \underline{Z. Zhang$\ast$}, X. Qiu, and C. Ding, ``A Novel Gradient Descent Least Squares (GDLS) Algorithm for Efficient Gridless Line Spectrum Estimation with Applications in Tomographic SAR Imaging,'' IEEE Trans. Geosci. Remote Sens., \emph{accepted}}.
