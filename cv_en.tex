...
\textsc{Address:} &  Room B203-12, Lab 22 \\
	...
	& Room 342, Lab 1 (National Key Lab on Microwave Imaging Technology) \\
...
\section*{Research Projects Cont.}
...
\begin{tabular}{r|p{11cm}}
	...
	\emph{2022.01} & Excellent Young Scientists Fund Program (Overseas) / \emph{NSFC}\\
	\multicolumn{2}{c}{} \\
	
	\emph{2021.01} & CAS ``One Hundred Talent'' / \emph{Chinese Academy of Sciences}\\
	\multicolumn{2}{c}{} \\
	
	
	\emph{2021.12} & Suzhou ``Gusu Leading Talent'' / \emph{Suzhou City}\\
	\multicolumn{2}{c}{} \\

	\emph{2022.12} & Jiangsu ``Innovative and Entrepreneurial Talent'' / \emph{Jiangsu Province}\\
	\multicolumn{2}{c}{} \\
	
	\emph{2022} & CAS ``Young Cross Teams'' Member / \emph{Chinese Academy of Sciences}\\
...
\begin{tabular}{r|p{11cm}}
	...
	~ & National Disruptive Technology Innovation Competition  / \emph{Ministry of Science and Technology, China}\\
	...
	\emph{2008.04} & TI DSP Contest / \emph{Texas Instruments} \\
	& \emph{Winner Prize}\\
	\multicolumn{2}{c}{} \\
	
	%------------------------------------------------
	
	~ & COMAP Mathematical Modeling Contest / \emph{COMAP}\\
	...
	\emph{2006.09} & China College Mathematical Modeling Contest / \emph{CSIAM}\\
	& \emph{Second Prize}\\
%	\multicolumn{2}{c}{} \\
...
\item \textbf{Y. Zhao,  Q. Liu, H. Tian, M. Luo, B. W.-K. Ling, and \underline{Z. Zhang$\ast$}, ``New Convex Approaches to General MVDR Robust Adaptive Beamforming Problems,'' Electron. Lett., under review.}.	
	
\item Y. Bai, J. Kang$\ast$, X. Ding, A. Zhang, \underline{Z. Zhang} and N. Yokoya, ``LaMIE: Large-Dimensional Multipass InSAR Phase Estimation for Distributed Scatterers,'' IEEE Trans. Geosci. Remote Sens., under review.
...
\item \textbf{D. Zhao, \underline{Z. Zhang$\ast$}, D. Lu, J. Kang,  X. Qiu and Y. Wu, ``CVGG-Net: Ship Recognition for SAR Images Based on Complex-Valued Convolutional Neural Network,'' IEEE Geosci. Remote Sens. Lett., accepted}.​
...
\item G. Zhou, Z. Xu, Y. Fan, \underline{Z. Zhang}, X. Qiu, B. Zhang, K. Fu$\ast$ and Y. Wu, ``HPHR-SAR-Net: Superpixel High-resolution SAR Imaging Network Based on Nonlocal Total Variation,'' IEEE J. Sel. Top. Appl. Earth Obs. Remote Sens., accepted. 
