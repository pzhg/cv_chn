...
\begin{tabular}{rl}
	& \textbf{Dean, Professor, Ph.D. Supervisor, IEEE Senior Member} \\
...
\textsc{Address (Beijing):}	&  Room 342, Main Bldg, Lab 1 \\
& Aerospace Information Research Institute, Chinese Academy of Sciences \\
& 19 West Beisihuan Road, Haidian District, Beijing 100190, China \\
\textsc{Address (Jinan):}	&  Room 5402, Teaching Bldg \#5, School of Electronics Information \\
...
\textsc{Homepage:} & \href{https://people.ucas.ac.cn/~zhe?language=en}{https://people.ucas.ac.cn/{\textasciitilde}zhe}.
...
\emph{2025.08--} & Dean\\	
\emph{2025.08--} & Professor, Ph.D Supervisor\\	
& \normalsize\textbf{School of Electronics Information, Aerospace Information Technology University}, Jinan, Shandong 250200, China \\
...
\emph{2023.01--} & Lab Vice Director, Academic Leader\\	
...
\emph{2021.01--2022.04} & Associate Professor\\	
	...
	& \normalsize\textbf{National Key Laboratory of Microwave Imaging}, Beijing 100190, China\\
	& \normalsize\textbf{Suzhou Aerospace Information Research Institute}, Suzhou, Jiangsu 215000, China\\
	& \normalsize\textbf{Suzhou Key Laboratory of Microwave Imaging, Processing and Application Technology}, Suzhou, Jiangsu 215000, China\\
%	& Excellent Young Scienctists Fund (Overseas) / {国家优青(海外)}\\
%	& CAS One Hundred Talent / {中国科学院``百人计划''}\\
%	& Gusu Leading Talent / {姑苏领军人才}\\
	& \emph{Interest Field: Sparse signal processing, Sparse Microwave Imaging, Synthetic aperture radar, Three-dimensional SAR imaging, Combination of signal processing and deep learning.} \\
...
\emph{2025.05--} & Adjunct Professor \\	
& \normalsize\textbf{Beijing University of Posts and Telecommunications}, Beijing, China \\
\multicolumn{2}{c}{} \\
...
\begin{longtable}{r|p{11cm}}
	...
	~ & \textbf{CIC}\\
	\emph{2025.05--} & \emph{Senior Member}\\
	~ & \textbf{Space-Air-Ground Integrated Network Communication Professional Committee}\\
	\emph{2024.06--} & \emph{Committee Member}\\
	\multicolumn{2}{c}{} \\
	%------------------------------------------------
...
\begin{itemize}
	\item \textit{Transactions on Pattern Analysis and Machine Intelligence} Journal, SCI.
	\item \textit{International Journal of Image and Data Fusion} Journal, SCI.
	\item \textit{CAAI Transactions on Intelligence Technology} Journal, SCI.
	\item \textit{IEEE Transactions on Antennas and Propagation} Journal, SCI.
	\item \textit{IEEE Transactions on Image Processing} Journal, SCI.
	\item \textit{IEEE Transactions on Aerospace and Electronic Systems} Journal, SCI.
	\item \textit{Journal of Electromagnetic Engineering and Science} Journal, SCI.
	\item \textit{IEEE Internet of Things Journal} Journal, SCI.
	\item \textit{Remote Sensing Letters} Journal, SCI.
	\item \textit{International Journal of Remote Sensing} Journal, SCI.
	\item \textit{IEEE Transactions on Industrial Informatics} Journal, SCI.
...
\end{itemize}
~\\
\textbf{Vice President of Organizing Committee Member} 
\begin{itemize}
	\item The 5th National Radar Earth Observation Symposium, Suzhou, China, May 23-25, 2025.
\end{itemize}
~\\
...
%\end{itemize}
\begin{longtable}{r|p{12cm}}
	\emph{2026} & PIERS 2026, ICC 2026. \\
	\multicolumn{2}{c}{} \\
	
	\emph{2025} & MWI 2025, EECSI 2025, iSemantic 2025, ISPA 2025, RAFC 2025. \\
	\multicolumn{2}{c}{} \\
...
\item 许文嘉, 于睿卿, 薛铭浩, 汪雪怡, 张源奔, 魏智威, \underline{张柘}, 彭木根, and 吴一戎, ``多模态对地观测大模型：架构、关键技术和未来展望,'' 雷达学报, vol. 15, no. 1, pp. 361--366, 2026.

\item \textbf{​Z. Ma, X. Ye, \underline{Z. Zhang$\ast$}, B. Zhang, and X. Qiu, ``PTIR-Net: A Joint Optimization Network of Pulse Transmission and Sparse Reconstruction for Azimuth Multichannel SAR System,'' IEEE Geosci. Remote Sens. Lett., vol. 23, pp. 1--5, 2026, doi: 10.1109/LGRS.2025.3645604.}

\item Y. Huang, W. Tie$\ast$, \underline{Z. Zhang}, H. Li, and D. Lu, ``Hierarchical Framework for Remote Sensing Deep Learning Evaluation on Terminal Devices,'' IEEE J. Sel. Top. Appl. Earth Obs. Remote Sens., vol. 18, pp. 28920--28938, 2025, doi: 10.1109/JSTARS.2025.3629641.
	
\item \textbf{​Z. Ma, \underline{Z. Zhang$\ast$}, B. Zhang, and X. Qiu, ``PUSIF-DUNet: Deep SAR Imaging Network With Joint Optimization on Learnable Probabilistic Undersampling and Unambiguous Reconstruction,'' IEEE J. Sel. Top. Appl. Earth Obs. Remote Sens., vol. 18, pp. 28217--28233, 2025, doi: 10.1109/JSTARS.2025.3625733.}
...
\item \textbf{\underline{Z. Zhang$\ast$}, ``New Era of Microwave Imaging: SAR Cognitive Imaging and Intelligent Perception Integration'', in 2025 IET International Radar Conference (IRC), Jiaxing, 2025, \emph{invited}}.
...
\begin{enumerate}
	\item [1] L. Peng, D. Zhao, R. Hu, S. Niu, \underline{Z. Zhang}, and X. Qiu, ``SAR Image Translation Based on Complex-Valued Convolutional Neural Networks: From Single Polarization to Full Polarization,'' in IGARSS 2025 - 2025 IEEE International Geoscience and Remote Sensing Symposium, IEEE, Aug. 2025, pp. 9342–9345. doi: 10.1109/igarss55030.2025.11242463.
	
	\item Y. Zhao, W. Yang, K. Han, W. K. Ling, Z. Pan, and \underline{Z. Zhang}, ``Sparse and Low-rank Decomposition of Hankel Matrix for SAR Imaging,'' 2024 4th Int. Conf. Commun. Technol. Inf. Technol. ICCTIT 2024, pp. 730--733, 2024, doi: 10.1109/ICCTIT64404.2024.10928650.
	...
	\item M. Wang, X. Qiu, S. Gao, and \underline{Z. Zhang}, ``LiDAR-to-SAR Point Cloud Segmentation via Unsupervised Domain Adaptation Network,'' in IGARSS 2024 - 2024 IEEE International Geoscience and Remote Sensing Symposium, IEEE, Jul. 2025, pp. 10808--10812. doi: 10.1109/igarss53475.2024.10641953.
...
\item 上官松涛, \underline{张柘}, and 仇晓兰, ``一种基于城区广泛强散射点参考的SAR辐射交叉定标方法,'' CN202511185894.0.

\item 周欣, 邢朕诏, \underline{张柘}, 蔺蓓, 彭凌霄, and 金燕, ``一种利用时间序列光学和SAR数据的冰川表面积雪识别方法'', CN202511027857.7.
