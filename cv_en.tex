...
\begin{enumerate}
	...
	\item \textcolor{blue}{\textbf{S. Gao, W. Wang, M. Wang, \underline{Z. Zhang$\ast$}, B. Zhang, and Y. Wu, ``Efficient gridless 2D DOA estimation based on generalized matrix-form atomic norm minimization,'' Electron. Lett., \emph{under review}}}.
